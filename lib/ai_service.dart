...
4. 행성이 다음 ℎ(하우스) 커스프 전방 5도 이내(Orb 5° 이내)에 위치한 경우, 물리적으로 이전 ℎ에 있더라도 실제 영향을 다음 ℎ에 미치는 것으로 우선 통합 해석하세요.
5. 결과를 출력할 때 불필요한 서론이나 맺음말을 생략하고, 바로 본론으로 시작하여 간결하게 작성하세요.
...
5. 행성이 다음 ℎ(하우스) 커스프 전방 5도 이내(Orb 5° 이내)에 위치한 경우, 물리적으로 이전 ℎ에 있더라도 실제 영향을 다음 ℎ에 미치는 것으로 우선 통합 해석하세요.
${isTimeUnknown ? '6. 출생 시간을 모르는 내담자이므로, ℎ(하우스 영역) 및 ASC/MC 관련 포지션 언급은 피하세요.' : ''}
''';
